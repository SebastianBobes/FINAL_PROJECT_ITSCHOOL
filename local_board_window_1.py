# Form implementation generated from reading ui file '.\local_board_window_1.ui'
#
...
class Ui_LocalBoard1Window(QMainWindow):
    def setupUi(self, LocalBoard1Window):
        LocalBoard1Window.setObjectName("LocalBoard1Window")
        LocalBoard1Window.resize(800, 600)
        LocalBoard1Window.setMinimumSize(QtCore.QSize(800, 600))
        LocalBoard1Window.setMaximumSize(QtCore.QSize(800, 600))
        self.centralwidget = QtWidgets.QWidget(parent=LocalBoard1Window)
...
"}")
        ...
        QtCore.QMetaObject.connectSlotsByName(LocalBoard1Window)

    def retranslateUi(self, LocalBoard1Window):
        ...
        self.label_9.setText(_translate("LocalBoard1Window", "<html><head/><body><p><span style=\" font-size:16pt; color:#ffffff;\">3.Evenimentele la care va participa membrul</span></p></body></html>"))
        self.label_5.setText(_translate("LocalBoard1Window", "<html><head/><body><p><span style=\" font-size:16pt; color:#ffffff;\">? </span></p></body></html>"))
        self.label_10.setText(_translate("LocalBoard1Window", "<html><head/><body><p><span style=\" font-size:16pt; color:#ffffff;\">sunt:</span></p></body></html>"))
        self.label_11.setText(_translate("LocalBoard1Window", "<html><head/><body><p><span style=\" font-size:16pt; color:#ffffff;\">4.Cati membrii din anul </span></p></body></html>"))
...
if __name__ == "__main__":
    ...
    LocalBoard1Window = QtWidgets.QMainWindow()
    ui = Ui_LocalBoard1Window()
    ui.setupUi(LocalBoard1Window)
    LocalBoard1Window.show()
    sys.exit(app.exec())
