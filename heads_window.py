...
"}")
        ...
        self.change_password_button.setGeometry(QtCore.QRect(530, 530, 131, 61))
...
"\n"
"QPushButton:hover {\n"
"    background-color: #45a049; /* Slightly lighter but closer to the original color */\n"
"    transform: scale(1.05); /* Increase size on hover */\n"
"}\n"
"\n"
"QPushButton:pressed {\n"
...
"}")
    ...
    def retranslateUi(self, HeadsWindow):
        ...
        self.head_of_label.setText(_translate("HeadsWindow", "<html><head/><body><p><span style=\" font-size:16pt; color:#00ff00;\">YOU\'VE LOGGED IN AS:</span></p><p><span style=\" font-size:16pt; color:#ff474c;\">MEMBER OF HEADS</span></p></body></html>"))
        ...
        self.back_pushButton.setText(_translate("HeadsWindow", "MENU"))
        self.label_14.setText(_translate("HeadsWindow", "<html><head/><body><p><span style=\" font-size:16pt; color:#ffffff;\">? </span></p></body></html>"))
        events = euroavia_db.read_parameter_from_db('events', 'event_id', 'name')
        for index in events.keys():
        ...
        for index in dep.keys():
                self.comboBox_2.setItemText(index - 1, _translate("HeadsWindow",f" {index}. {dep[index]}"))
        faculties = euroavia_db.read_parameter_from_db('faculties', 'id', 'name')
        for index in faculties.keys():
        ...
        for index, value in enumerate(x):
                ...
                self.comboBox_3.setItemText(index, _translate("HeadsWindow", f"{value}. {first_name} {last_name}"))
